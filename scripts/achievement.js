(function(){
  achievementName = [
    ...
    'Second Meta', 'Mastered 2.5', 'Boost goes brrrrr', 'Virtual memory', 'meta-Quantum'
  ];
  achievementGoal = [
  ...
  achievementGoalFunc = [
    ...
    'D(GameSlot.simulation.researchPoint).gte(1)', 'game.metaMaterial.gte(2)', 'game.quantumUpgradeBought.length>=49 && game.challengeEntered == 3', 'GameSlot.simulation.researchLevel[0] >= 30', 'D(GameSlot.simulation.quantumLab).gte(1)',
  ];
})();
