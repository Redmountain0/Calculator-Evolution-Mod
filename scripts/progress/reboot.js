...
function calcRPGain() {
  ...
  if (GameSlot.now == 1 && GameSlot.main.metaUpgradeBought.includes(5)) tempNum = tempNum.mul(D(GameSlot.main.metaRecord[0]).add(2).pow(4));
...
function calcPerResearchSpeedBase() {
  ...
  if (game.quantumUpgradeBought.includes('27') && game.singularityPower.gte(1)) base = base.mul(game.singularityPower.div(10000).log(1000).add(3));
